...
export default function Cart() {
  ...
  if (cart.length === 0) {
    return (
      <div className="h-[250px] bg-white rounded-lg py-8">
        ...
        <div className="flex flex-col items-center pt-3">
          ...
          <p className="text-sm text-rose-900 pt-4">
  ...
  return (
    <div className=" bg-white rounded-lg py-8 px-4">
      ...
      <h2 className="text-xl  text-rose-950 font-bold">
      ...
      <div className="w-full bg-gray-100 rounded-md py-3">
        <div className="flex justify-center items-center gap-1">
          <img src={tree} alt="" />
          <p className="text-xs">
            This is a <span className="font-semibold">Carbon-Neutal</span>{" "}
            delivery
          </p>
        </div>
      </div>
